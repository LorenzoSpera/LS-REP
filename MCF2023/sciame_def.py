...
class sciame_elettromagnetico:
    ...
    def simulazione_sciame(self):
        ...
        if grafici == 1:
            ...
            if (grafico_energia_per_step == 1):
                ...
                plt.plot(array_passi[:-1], energie[:-1], "+", c='red' , label='Energia persa per step')
                plt.plot(array_passi[:-1], energie[:-1], "--", c='blue' )
            ...
            if grafico_particelle_per_step == 1:
                ...
                ax[0][0].plot(array_passi[:-1], n_elettroni_totali[:-1], "+",label ='# elettroni per step', c='blue')
                ax[0][0].plot(array_passi[:-1], n_elettroni_totali[:-1], "--", c ='red')
                ax[0][1].plot(array_passi[:-1], n_fotoni_totali[:-1],"+", label ='# fotoni per step', c='orangered')
                ax[0][1].plot(array_passi[:-1], n_fotoni_totali[:-1],"--", c='steelblue')
                ax[1][0].plot(array_passi[:-1], n_positroni_totali[:-1], "+", label ='# positroni per step', c='mediumblue')
                ax[1][0].plot(array_passi[:-1], n_positroni_totali[:-1], "--",  c='gray')
                ax[1][1].plot(array_passi[:-1], somma_particelle[:-1],"+", label ='# particelle per step', c='chocolate')
                ax[1][1].plot(array_passi[:-1], somma_particelle[:-1],"--", c='forestgreen')
            ...
            if grafico_particelle_step_totali == 1:
                ...
                plt.plot(array_passi[:-1], somma_particelle[:-1], "+", label='# particelle totali', c='chocolate')
                plt.plot(array_passi[:-1], somma_particelle[:-1], "--", c='forestgreen')
                plt.xlabel('Numero di step')
                plt.ylabel('Numero di particelle')
                plt.legend(loc = 'upper right')
                plt.show()
            ...
            if (grafico_energia_residua_step == 1):
                ...
                plt.plot(array_passi[:-1], array_energia_corrente[:-1], "+", c='red', label='Energia ad ogni step')
                plt.plot(array_passi[:-1], array_energia_corrente[:-1], "--", c='blue')
                plt.xlabel('Numero di step')
    ...
    def confronta_sciame(tipo_particella, E00, E01, E02, Ec_elettroni_h20, Ec_positroni_h20,
        ...
        if confronto_grafico == 1:
            ...
            ax[0][0].plot(step1[:-1], num1[:-1], "--", c='blue')
            ax[0][0].plot(step1[:-1], num1[:-1], "+", c='red',label='$E_0$ = {:.2f} MeV'.format(E00))
            

            #simulazione 2 per acqua
            ax[0][0].plot(step2[:-1], num2[:-1], "--", c='steelblue')
            ax[0][0].plot(step2[:-1], num2[:-1], "+", c='orange',label='$E_0$ = {:.2f} MeV'.format(E01))

            # simulazione 3 per acqua
            ax[0][0].plot(step3[:-1], num3[:-1], "--", c='limegreen')
            ax[0][0].plot(step3[:-1], num3[:-1], "+", c='magenta',label='$E_0$ = {:.2f} MeV'.format(E02))
            ...
            # simulazione 1 per acqua
            ax[0][1].plot(step1[:-1], energia1[:-1], "--", c='blue')
            ax[0][1].plot(step1[:-1], energia1[:-1], "+", c='red',label='$E_0$ = {:.2f} MeV'.format(E00))

            #simulazione 2 per acqua
            ax[0][1].plot(step2[:-1], energia2[:-1], "--", c='steelblue')
            ax[0][1].plot(step2[:-1], energia2[:-1], "+", c='orange',label='$E_0$ = {:.2f} MeV'.format(E01))

            # simulazione 3 per acqua
            ax[0][1].plot(step3[:-1], energia3[:-1], "--", c='limegreen')
            ax[0][1].plot(step3[:-1], energia3[:-1], "+", c='magenta',label='$E_0$ = {:.2f} MeV'.format(E02))
            ...
            ax[1][0].plot(step4[:-1], num4[:-1], "--", c='blue')
            ax[1][0].plot(step4[:-1], num4[:-1], "+", c='red',label='$E_0$ = {:.2f} MeV'.format(E00))

            #simulazione 2 per silicato di bismuto 
            ax[1][0].plot(step5[:-1], num5[:-1], "--", c='steelblue')
            ax[1][0].plot(step5[:-1], num5[:-1], "+", c='orange',label='$E_0$ = {:.2f} MeV'.format(E01))

            # simulazione 3 per silicato di bismuto 
            ax[1][0].plot(step6[:-1], num6[:-1], "--", c='limegreen')
            ax[1][0].plot(step6[:-1], num6[:-1], "+", c='magenta',label='$E_0$ = {:.2f} MeV'.format(E02))
            ...
            # simulazione 1 per silicato di bismuto 
            ax[1][1].plot(step4[:-1], energia4[:-1], "--", c='blue')
            ax[1][1].plot(step4[:-1], energia4[:-1], "+", c='red',label='$E_0$ = {:.2f} MeV'.format(E00))

            #simulazione 2 per silicato di bismuto 
            ax[1][1].plot(step5[:-1], energia5[:-1], "--", c='steelblue')
            ax[1][1].plot(step5[:-1], energia5[:-1], "+", c='orange',label='$E_0$ = {:.2f} MeV'.format(E01))

            # simulazione 3 per silicato di bismuto 
            ax[1][1].plot(step6[:-1], energia6[:-1], "--", c='limegreen')
            ax[1][1].plot(step6[:-1], energia6[:-1], "+", c='magenta',label='$E_0$ = {:.2f} MeV'.format(E02))
